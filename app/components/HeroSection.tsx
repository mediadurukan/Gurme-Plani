        ...
        <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
          ...
          >
            <motion.button
              ...
              className="relative flex items-center justify-center text-white text-xl font-bold px-12 py-5 sm:py-6 rounded-full overflow-hidden w-full sm:w-auto"
              style={{
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.96 }}
              className="flex items-center justify-center text-orange-400 text-xl font-semibold px-12 py-5 sm:py-6 rounded-full transition-all duration-300 w-full sm:w-auto"
              style={{
