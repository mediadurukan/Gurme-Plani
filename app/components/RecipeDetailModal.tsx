        ...
        <>
          ...
          <div className="fixed inset-0 z-[70] flex items-end sm:items-center justify-center p-0 sm:p-4" onClick={onClose}>
            <motion.div
              ...
              style={{ maxHeight: "90vh", border: "1px solid rgba(249,115,22,0.15)", boxShadow: "0 20px 60px rgba(0,0,0,0.1)", WebkitOverflowScrolling: "touch", overscrollBehavior: "contain" }}
            >
              {/* Fotoğraf alanı */}
